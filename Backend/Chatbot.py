...
def ChatBot(Query):
    ...
    try:
        ...
        Answer = ""  # Initialize an empty response.
    ...
    # Process the streamed response chunks.
        ...
        Answer = Answer.replace("</s>", "")  # Clean up unwanted tokens from the response.
...
if __name__ == "__main__":
    while True:
        user_input = input(" ask some think")  # Prompt the user for a question.
