...
***  use proper grammar and keep answer as small as you can .***
...
def RealtimeSearchEngine(prompt):
    ...
    MAX_HISTORY = 10  # You can adjust this number based on your needs
    messages = messages[-MAX_HISTORY:]  # Keep only the last N messages
