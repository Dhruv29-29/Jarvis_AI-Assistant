from PyQt5.QtWidgets import QApplication,QHBoxLayout, QMainWindow, QTextEdit, QStackedWidget, QWidget, QLineEdit, QGridLayout,QVBoxLayout, QVBoxLayout, QPushButton, QFrame, QLabel, QSizePolicy
...
class ChatSection(QWidget):
        ...
        def load_icon(self, path, width=60, height=60):
            pixmap = QPixmap(path)
            new_pixmap = QPixmap(path).scaled(width, height)
